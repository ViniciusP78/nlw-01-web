...
// Sempre que criamos um estado em um array ou objeto, precisamos manualmente informar o tipo da variável
...
const CreatePoint = () => {
    ...
    useEffect(() => { // Utilizado para que a função da api só ocorra uma única vez
